...
void Board::hostGame()
{
	...
	do
	{
		...
		{
			gameOver=true;
			cout<<"Congradulations " << player1name << "! You Won!\n";
		}
		// end game - win message player 2
		else if (hasWon('o'))
		{
			gameOver=true;
			cout<<"Congradulations " << player2name << "! You Won!\n";
		}
...
void gamebox()
{
	...
	cout << "Created by Thierry muhirwa and icyeza ngabo christal" << endl;
	cout << "Made for kids 8 to 108!\n\n\n" << endl;
	do
	{
		...
		if(players == 1)
		{
			cout << " Computer opponent coming soon!!!" << endl;
			char e;
			cin >> e;
		}
		else if(players==2)
